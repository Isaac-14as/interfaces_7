...
import withHocs from './BooksDialogHoc';

class BooksDialog extends React.Component {

  handleDelete = () => {
    const { id, handleClose, deleteBook } = this.props;
    deleteBook(id);
    handleClose();
  }
...
export default withHocs(BooksDialog);
