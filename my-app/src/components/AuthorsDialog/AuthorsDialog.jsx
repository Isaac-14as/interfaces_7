...
import withHocs from './AuthorsDialogHoc';

class AuthorsDialog extends React.Component {

  handleDelete = () => {
    const { id, handleClose, deleteAuthor } = this.props;
    deleteAuthor(id);
    handleClose();
  }
...
export default withHocs(AuthorsDialog);
