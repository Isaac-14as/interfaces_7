...
import withHocs from './BooksTableHoc';
...
class BooksTable extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <BooksDialog open={openDialog} handleClose={this.handleDialogClose} id={activeElem.id} />
                ...
                return (
                  <TableRow key={book.id}>
                    ...
                    <TableCell align="right">
                      <>
                        <IconButton color="inherit" onClick={(e) => this.handleClick(e, book)}>
                          <MoreIcon />
                        </IconButton>
...
export default withHocs(BooksTable);